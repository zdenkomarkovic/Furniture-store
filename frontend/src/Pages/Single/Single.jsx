      ...
      <div className="single container">
        ...
        >
          ...
          <div className="includes">
            <h3>Dimensions</h3>
            <div className="items">
              <p className="item-name">Width:</p>
              <p className="item-qty">{product?.width} cm</p>
            </div>
            <div className="items">
              <p className="item-name">Depth:</p>
              <p className="item-qty">{product?.depth} cm</p>
            </div>
            <div className="items">
              <p className="item-name">Height:</p>
              <p className="item-qty">{product?.height} cm</p>
            </div>
          </div>
        </motion.div>
        {/* <motion.div
